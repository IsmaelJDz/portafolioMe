<?php
	...
	$mail->Host = 'mail.ismaeljdz7.com';  // Specify main and backup SMTP servers
	$mail->Port       = 25;   // set the SMTP port for the GMAIL server
	$mail->SMTPAuth = true;                               // Enable SMTP authentication
	$mail->Username = '_mainaccount@ismaeljdz7.com';                 // SMTP username
	$mail->Password = '8B92golBVWjk';                           // SMTP password
